...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BPCategoryKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jfr0524@qq.com/BPCategoryKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jfr0524@qq.com' => 'jfr0524@qq.com' }
  s.source           = { :git => 'https://github.com/jfr0524@qq.com/BPCategoryKit.git', :tag => s.version.to_s }
